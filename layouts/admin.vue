<template>
  <div v-if="showAdmin" class="min-h-screen flex flex-col bg-gray-100">
    ...
    <header class="admin-mobile-topbar bg-[#1a2d4a] text-white items-center gap-3 px-4 h-14 shrink-0">
      <button
        type="button"
...
<style scoped>
/* Não usar hidden/flex do Tailwind aqui: em produção o flex ganha do breakpoint. */
.admin-mobile-topbar {
